...
class HttpConnectorConfigCustomization(runtimeConfig: RuntimeConfig) : ConfigCustomization() {
    private val codegenScope = arrayOf("HttpConnector" to runtimeConfig.httpConnector())
